...
//                    Log.e("里程", ":" + distance_values+"km");
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if (StepDetector.CURRENT_SETP > custom_steps){
            Toast.makeText(getContext(),"You have reached your step target, please exercise moderately!"
        ...
        if (SaveKeyValues.getIntValues("do_hint",0) == 1
            ...
            alertDialog.setMessage("You have unfinished plans!");
            alertDialog.setPositiveButton("Click OK to not be prompted again!",
    ...
    private void initValues(){
        //1、获取所在城市并获取该城市的天气信息
        query_city_name = SaveKeyValues.getStringValues("city", "Beijing");
        try {
            //使用URLEncoder这个方法
            // 请在gradle中依赖
    ...
    private void setNature() {
        ...
        warm_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "Jump to the warm-up interface!", Toast.LENGTH_SHORT).show();
...
//                         .putExtra("random",new Random().nextInt(5)));
        ...
        want_steps.setText("Today Target "+custom_steps+" Steps");
