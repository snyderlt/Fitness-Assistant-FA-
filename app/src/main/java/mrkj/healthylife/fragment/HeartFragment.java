...
public class HeartFragment extends BaseFragment implements View.OnClickListener{
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1){
                ...
                if (progess == 10){
                    Toast.makeText(getContext(),"Test Finish",Toast.LENGTH_SHORT).show();
                    if (timer != null){
                        timer.cancel();
                        task.cancel();
                    }
    ...
    private final SurfaceHolder.Callback holderCallBack = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            Log.e("surfaceCreated", "Drawing Start");
            }


        @Override
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            Log.e("surfaceChanged", "Drawing Changed");
        }

        @Override
        public void surfaceDestroyed(SurfaceHolder holder) {
            Log.e("surfaceDestroyed", "Drawing Finish");
        }
    };
    /**
     * 初始化控件
        ...
        for (int camIdx = 0; camIdx < cameraCount; camIdx++) {
            ...
            if (cameraInfo.facing == backOrFont) {
                try {
                    ...
                    Log.e(TAG, "Failed to open the camera:" + e.getLocalizedMessage());
                }
            }
        }
        return mCamera;
...
//            Toast.makeText(context,"执行了！",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(context,"Your phone doesn't have a camera!",Toast.LENGTH_SHORT).show();
        }
    ...
    private static Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (totalTimeInSecs >= 2) {
                ...
                Log.e(TAG,"Heart Rate: "+String.valueOf(beatsAvg)+"BPM");
    ...
    private void updateChart() {
        if(flag==1)
            ...
            if(imageReslutValues<200){
                if(values[20]>1){
                    Toast.makeText(context, "Cover the camera lens with your fingertip!", Toast.LENGTH_SHORT).show();
                    values[20]=0;}
                values[20]++;
                return;}
            else
