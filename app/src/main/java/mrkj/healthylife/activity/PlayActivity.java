            ...
            switch (msg.what){
                case 1:
                    ...
                    if (values1 == 12){
                        ...
                        Toast.makeText(PlayActivity.this, "Sports Finish", Toast.LENGTH_SHORT).show();
                    }
                    break;
                default:
                    break;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.play_next://播放下一个
                ...
                index++;
                if (index > 4){
                    Toast.makeText(this,"After warming up, please click Return to Exercise!",Toast.LENGTH_SHORT).show();
                }else {
                    animationDrawable.stop();
                    isOff = false;
                    isClose = true;
