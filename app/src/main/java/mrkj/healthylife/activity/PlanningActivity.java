        ...
        switch (v.getId()){
            ...
            case R.id.finish://完成
                ...
                if (plan_want_weight < min_normal_weight){
                    Toast.makeText(this,"Please set your target weight within the recommended range!",Toast.LENGTH_SHORT).show();
                    ...
                    if ((!getString(R.string.set_start_time).equals(start_dates))&&(!getString(R.string.set_stop_time).equals(stop_dates))){
                       if ((start_date <= stop_date) && (start_year <= stop_year) && (start_month <= stop_month)){
                           ...
                           Toast.makeText(this,"Please set a reasonable time. The end time must not be less than the start time!",Toast.LENGTH_SHORT).show();
                       }
                    }else {
                        Toast.makeText(this,"Please set the start and end time for your health goal!",Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(this,"Please set your target weight within the recommended range!",Toast.LENGTH_SHORT).show();
                }
