...
public class MinePlanActivity extends BaseActivity {
    ...
    class MyAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            holder.hint_time.setText("Time"+map.get("time").toString());//时间点
            holder.name.setText(DemoApplication.shuoming[((int) map.get("type"))]);//类型
            holder.count.setText(FindFragment.cishu);
            holder.change.setText("Change Plan");
            holder.delete.setText("Delete Plan");
            ...
            holder.change.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (id == (int)holder.change.getTag()){
                        ...
                        Toast.makeText(getApplicationContext(), "Change Plan", Toast.LENGTH_SHORT).show();
                    }
                }
            });
                    ...
                    if (id == (int)holder.delete.getTag()){
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                noti();
                                Toast.makeText(getApplicationContext(), "Delete a plan", Toast.LENGTH_SHORT).show();
                            }
                        });
                        builder.create();
                        builder.show();
